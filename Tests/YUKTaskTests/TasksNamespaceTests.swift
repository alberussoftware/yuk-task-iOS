...
final class TasksNamespaceTests: XCTestCase {
  ...
  func testMapTask() {
    ...
    wait(for: [expec1, expec2], timeout: 3.0)
  }
  ...
  func testFlatMapTask() {
    ...
    wait(for: [expec1, expec2], timeout: 5.0)
  }
  ...
  func testTryCatchTask() {
    ...
    wait(for: [expec1, expec2, expec3], timeout: 5.0)
  }
    ...
    let task1 =
      ...
      .recieve {
        ...
        case let .success(value):
          ...
          {"id":21,"username":"jeudesprits"}
          """
          XCTAssertEqual(value, json.data(using: .utf8)!)
          expec1.fulfill()
        default:
          XCTFail()
        }
